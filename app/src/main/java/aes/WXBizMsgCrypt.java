...
import org.apache.commons.codec16aluo.binary.Base64;
...
//		byteCollector.addBytes(networkBytesOrder);
	...
	//		int xmlLength = recoverNetworkBytesOrder(networkOrder);
			...
			xmlContent = new String(Arrays.copyOfRange(bytes, 16,bytes.length), CHARSET);
...
//		}
	...
	public String EncryptMsg(String replyMsg, String timeStamp) throws AesException {
		...
		String result = null;
		try {
			result = XMLParse.generate(encrypt, signature, timeStamp, nonce);
		} catch (Exception e) {
	 ...
	 * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
	 */
	public String DecryptMsg(String text, String msgSignature, String timeStamp, String nonce)
			throws AesException {
...
//		Object[] encrypt = XMLParse.extract(postData);
		...
		// 验证安全签名
		String signature = SHA1.getSHA1(token, timeStamp, nonce, text);
